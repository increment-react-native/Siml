       ...
       <View onLayout={(evt)=>{this.getNewDimensions(evt)}}>
         {this.props.search && <View style={{ flexDirection: 'row', height: 55 }}>
           <View style={{ marginTop: 15, marginLeft: 15, backgroundColor: 'transparent' }}>
             <FontAwesomeIcon icon={faSearch} color={this.props.iconColor} size={25}/>
           </View>
           <TextInput
             style={{
             ...
             return(
               ...
               >
                 <Text>{label}</Text>
                 {
                   ...
                   <FontAwesomeIcon icon={this.props.selectedIconName} color={Color.primary} size={20} />
                   :
                   <FontAwesomeIcon icon={this.props.unselectedIconName} color={'transparent'} size={this.props.iconSize} />
                 }
               </TouchableOpacity>
             )
           })}
